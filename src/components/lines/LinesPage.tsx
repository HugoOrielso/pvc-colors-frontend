    ...
    <>
      ...
      <main className="pvc-page overflow-hidden bg-white text-[#061540]">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-12 lg:pb-20">
          <div className="fade-up overflow-hidden rounded-2xl bg-[#061540] p-8 shadow-xl md:p-10">
            <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#f0c040]">
                  ¿Necesitas asesoría?
                </p>
                ...
                <p className="mt-3 max-w-2xl text-sm font-light leading-7 text-white/70">
                  Cuéntanos qué superficie quieres trabajar y te orientamos con
                  la mejor opción.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/contact"
                  className="rounded-full bg-white px-6 py-4 text-center text-sm font-bold text-[#061540] transition hover:bg-[#f0c040]"
                >
                  Contactar ahora
                </Link>
                ...
                <Link
                  href="/calculator"
                  className="rounded-full border border-white/20 px-6 py-4 text-center text-sm font-bold text-white transition hover:bg-white hover:text-[#061540]"
                >
                  Usar calculadora
                </Link>
              </div>
