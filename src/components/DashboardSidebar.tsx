...
export default function DashboardSidebar() {
        ...
        <SidebarMenuItem key={href}>
          <SidebarMenuButton
            ...
            className={cn(
              ...
              (isActive || isChildActive) && "bg-blue-100 hover:bg-blue-100 font-semibold"
            )}
          >
                ...
                <SidebarMenuItem key={childHref}>
                  <SidebarMenuButton
                    className={cn(
                      ...
                      pathname === childHref && "bg-blue-100 hover:bg-blue-100 font-semibold"
                    )}
                  >
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        pathname === sub.href && "bg-blue-100 hover:bg-blue-100 font-semibold"
                      )}
                    >
    ...
    return (
      <SidebarMenuItem key={href}>
        <SidebarMenuButton
          ...
          className={cn(
            "border-none shadow-none hover:bg-white focus-visible:ring-0 focus-visible:ring-offset-0",
            isActive && "bg-blue-100 hover:bg-blue-100 font-semibold"
          )}
        >
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarHeader className="px-4 py-3 flex items-center justify-center group-data-[collapsible=icon]:hidden">
        <Image src={"/assets/logo.webp"} width={100} height={100} alt="logo" />
